export const content = {
  ...
  about: {
    eyebrow: 'WHO I AM',
    statement: '我相信好的设计不是制造更多噪音，而是在复杂问题里，找到那条最清晰、最有人情味的路径。',
    description: '3 年+ UI 与视觉设计经验，参与从概念定义、组件系统到上线验收的完整流程。曾服务腾讯、西山居、欧派与一加等品牌。',
    gallery: [
      { src: '/media/portfolio/page-06.jpg', alt: 'FateLinked 项目主视觉', label: 'FATELINKED · PRODUCT OVERVIEW' },
      { src: '/media/portfolio/page-17.jpg', alt: 'FateLinked 全流程界面展示', label: 'FATELINKED · APP EXPERIENCE' },
      { src: '/media/portfolio/page-18.jpg', alt: 'PulseBeat 线上商城视觉', label: 'PULSEBEAT · SHOPPING APP' },
      ...
      { src: '/media/portfolio/page-39.jpg', alt: 'QINRIVE 企业站视觉设计', label: 'QINRIVE · WEB EXPERIENCE' },
      { src: '/media/portfolio/page-43.jpg', alt: '企业数据看板界面', label: 'DASHBOARD · INTERFACE SYSTEM' },
