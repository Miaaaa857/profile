export default function Footer({ data, onContact }) {
  return (
    <footer className="footer" id="contact">
      ...
      <div className="footer-panel">
        <div className="container footer-grid">
          <div><a className="footer-email" href={`mailto:${data.designer.email}`}>{data.site.footerContactLabel} ↗</a><p>{data.site.footerLocation}</p></div>
        ...
        <div className="container footer-bottom"><p>{data.site.copyright}</p><a href="#home">{data.site.backToTop} ↑</a></div>
      </div>
    </footer>
  )
}
